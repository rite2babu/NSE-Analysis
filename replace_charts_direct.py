"""
Direct replacement of matplotlib charts with Plotly in NSE_Analysis.ipynb
"""
...
# Find and replace Section 4d (starts with "## 4d." and ends before "## 4e.")
import re

# Pattern to match Section 4d
pattern_4d = r'## 4d\. Top Gainers Chart.*?(?=## 4e\.)'
content = re.sub(pattern_4d, new_4d + '\n', content, flags=re.DOTALL)

# Pattern to match Section 4e  
pattern_4e = r'## 4e\. Top Losers Chart.*?(?=## 4f\.)'
content = re.sub(pattern_4e, new_4e + '\n', content, flags=re.DOTALL)
