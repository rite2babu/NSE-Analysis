...
import matplotlib
import os
# This must be in the first lines
...
# ValueError: 'w10agg' is not a valid value for backend; supported values are 
# ['GTK3Agg', 'GTK3Cairo', 'GTK4Agg', 'GTK4Cairo', 'MacOSX', 'nbAgg', 'QtAgg', 
# 'QtCairo', 'Qt5Agg', 'Qt5Cairo', 'TkAgg', 'TkCairo', 'WebAgg', 'WX', 
...
dfs = pd.read_csv(MY_PATH+"./dump/STKS-HIS2024-02-02-13-04-27.csv")
