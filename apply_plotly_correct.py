...
new_4d_code = """from plotly.subplots import make_subplots
...
new_4e_code = """# Get top 10 losers for each period
...
nb['cells'][15]['source'] = ['## 4d. Top Gainers Chart (Plotly - Horizontal Bars)']
nb['cells'][17]['source'] = ['## 4e. Top Losers Chart (Plotly - Horizontal Bars)']

# Replace code cells (cell 16 is after markdown 15, cell 18 is after markdown 17)
nb['cells'][16]['source'] = new_4d_code.split('\n')
nb['cells'][18]['source'] = new_4e_code.split('\n')

# Write back
with open('NSE_Analysis.ipynb', 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)

print("[+] Successfully replaced sections 4d and 4e with Plotly charts!")
print("\nChanges:")
print("- Cell 15: Updated markdown header for 4d")
print("- Cell 16: Replaced matplotlib code with Plotly for Top Gainers")
print("- Cell 17: Updated markdown header for 4e")
print("- Cell 18: Replaced matplotlib code with Plotly for Top Losers")
print("\nFeatures:")
